$(document).ready(function(){
	$(".btncomprar").click(function(){
		...
		var total_precio = $("#total_pedido input").eq(0).val();
		total_precio = parseInt(total) + parseInt(total_precio);
		$("#total_pedido input").eq(0).val(total_precio);
