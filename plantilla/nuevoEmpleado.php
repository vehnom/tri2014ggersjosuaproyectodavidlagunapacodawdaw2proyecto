				...
				<center>
					<form id="formNuevoEmpleado">
						...
						<div class="thumb">
							...
							<input type="tel" id="telefono1" name="telefono1" placeholder="Telefono principal" required/> <br>
							<input type="tel" id="telefono2" name="telefono2" placeholder="Telefono secundario" required/> <br>
						</div>
						<div class="thumb thumb2">
							<input type="text" id="direccion" name="direccion" placeholder="Direccion" required/> <br>
							<input type="text" id="dni" name="dni" placeholder="DNI" maxlength="9" required/> <br>
						...
						<div class="thumb thumb3">
							<input type="submit" id="enviar" name="enviar" value="Crear empleado"/>	
						</div>
					</form>
				</center>
			</div>
