			...
			<div class="fila_thumbs">
				<center>
					<form action="../services/operarios/insertOperario.php" method="post" id="formNuevoEmpleado" name="formNuevoEmpleado">
						<h2 style="font-size:60px; color: #aaa;"> Editar Operario </h2>
						<div class="thumb">
							<input type="text" id="idUsuario" name="idUsuario" placeholder="Identificador Usuario" value="<?php echo $_SESSION['operario']['Id_Operario']; ?>" required/> <br>
